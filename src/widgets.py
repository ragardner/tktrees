...
class Date_Entry(tk.Frame):
    def __init__(self, parent, DATE_FORM, theme="dark"):
        ...
        self.sv_1.trace_add("write", lambda name, index, mode, sv=self.sv_1: self.validate_1(self.sv_1))
        self.sv_2.trace_add("write", lambda name, index, mode, sv=self.sv_2: self.validate_2(self.sv_2))
        self.sv_3.trace_add("write", lambda name, index, mode, sv=self.sv_3: self.validate_3(self.sv_3))
